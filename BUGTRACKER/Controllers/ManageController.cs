    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.ChangeProfileFailed ? "Email address already Existed."
                : "";
        ...
        {
            var name = new ChangeProfileViewModel();
        ...
        public ActionResult ChangeProfile(ChangeProfileViewModel model)
        {
            ...
            else
            {
                ...
                var login = db.DemoLogins.FirstOrDefault(l => l.UserName == user.Email);
